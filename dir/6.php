...
<body>
	...
	<section id="section" class="section">
		<div class="image">
			<img src="../src/img/bullfrog.jpg" alt="hello">
		</div>
		<div class="info">
			<h2>
				Лягушка-бык!
			...
			<p>
				Обитающий в Северной Америке, этот крупный вид лягушек, хотя и уступает африканской лягушке-голиафу в размерах, громко заявляет о себе другим образом. По весне лягушки-быки издают оглушительное кваканье, больше напоминающее мычание стада коров. Рев одной только лягушки можно услышать с расстояния в 3 километра. Однако, в отличие от настоящих быков, лягушка-бык вовсе не вегетарианка: питается она моллюсками, насекомыми, а также птенцами и маленькими рыбешками.
			</p>
		</div>
		<div class="comfield">
			...
			<form action="comments.php" method="post">
				<input class = "pg" name="pg" id="pg" type="text" value="6"></input>
