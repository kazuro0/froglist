...
<body>
	...
	<section id="section" class="section">
		<div class="image">
			<img src="../src/img/shitos.jpg" alt="hello">
		</div>
		<div class="info">
			<h2>
				Щитоспинка!
			...
			<p>
				Щитоспинка, известна еще как лягушка Баджита. Имеет необычную форму тела - она идеально круглая. В момент опасности она набирает воздух и становится шаровидной, при этом выпрямляет ноги, нахлабучивается и издает громкие, пугающие звуки. У головастиков практикуется каннибализм - они поедают друг друга.
			</p>
		</div>
		<div class="comfield">
			...
			<form action="comments.php" method="post">
				<input class = "pg" name="pg" id="pg" type="text" value="2"></input>
